...
/** The SDL3 video driver. */
class VideoDriver_SDL3_Base : public VideoDriver {
public:
	VideoDriver_SDL3_Base(bool uses_hardware_acceleration = false) : VideoDriver(uses_hardware_acceleration), sdl_window(nullptr), buffer_locked(false) {}
...
private:
	...
	static void EmscriptenLoop(void *self) { ((VideoDriver_SDL3_Base *)self)->LoopOnce(); }
#endif
