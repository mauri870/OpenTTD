...
static FVideoDriver_SDL3_Default iFVideoDriver_SDL3_Default;
...
void VideoDriver_SDL3_Default::UpdatePalette()
{
	SDL_Color pal[256];
...
void VideoDriver_SDL3_Default::MakePalette()
{
...
void VideoDriver_SDL3_Default::Paint()
{
...
bool VideoDriver_SDL3_Default::AllocateBackingStore(int w, int h, bool force)
{
	...
	if (bpp == 8) {
		_sdl_rgb_surface = SDL_CreateSurface(w, h, SDL_PIXELFORMAT_ARGB32);
...
void *VideoDriver_SDL3_Default::GetVideoPointer()
{
